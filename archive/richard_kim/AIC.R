...
#Imputing Electrical -- Based on Mode ####
...
# lm(log(SalePrice) ~ .-Id-Utilities-MiscFeature, data = hp)

model.empty = lm(log(SalePrice) ~ 1, data = hp) #The model with an intercept ONLY.
